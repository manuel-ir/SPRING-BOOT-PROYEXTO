# SPRING-BOOT-PROYEXTO# Documentación de Pruebas API REST - Proyecto UD2
...
![Crear Usuario Correcto](demo\src\main\capturas\CrearUsuario.png)
...
![Error al Crear Usuario](demo\src\main\capturas\UsuarioErroneo.png)

### 2.3. Actualizar Usuario (PUT)
Se modifica un usuario existente buscando por su ID.
**Ruta:** `PUT /api/usuarios/{id}`

![Modificar Usuario](demo\src\main\capturas\PUTUsuario.png)
...
![Borrar Usuario](demo\src\main\capturas\BorrarUsuario.png)
...
![Crear Ruta Correcta](demo\src\main\capturas\CrearRuta.png)
...
![Crear Valoración Correcta](demo\src\main\capturas\CrearValoracion.png)
...
![Borrar Valoración](demo\src\main\capturas\BorrarValoracion.png)
