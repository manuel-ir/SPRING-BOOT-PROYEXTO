...
![Crear Usuario Correcto](src/main/capturas/CrearUsuario.png)
...
![Error al Crear Usuario](src/main/capturas/UsuarioErroneo.png)

### 2.3. Actualizar Usuario (PUT)
Se modifica un usuario existente buscando por su ID.
**Ruta:** `PUT /api/usuarios/{id}`

![Modificar Usuario](src/main/capturas/PUTUsuario.png)
...
![Borrar Usuario](src/main/capturas/BorrarUsuario.png)
...
![Crear Ruta Correcta](src/main/capturas/CrearRuta.png)
...
![Crear Valoración Correcta](src/main/capturas/CrearValoracion.png)
...
![Borrar Valoración](src/main/capturas/BorrarValoracion.png)
